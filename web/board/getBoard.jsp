...
<div class="container">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/notice/boardList.jspp">커뮤니티</a> &gt; <span>게시판 글 상세보기</span></p>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">게시판 글 상세보기</h2>
                <hr>
                <!-- 5. Board 객체의 내용을 출력 -->
                <table class="tb1">
                    <tbody>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <a href="/notice/updateBoard.jspp?bno=<%=bd.getBno() %>" class="inbtn">글 수정</a>
