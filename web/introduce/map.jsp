...
<head>
    ...
    <link rel="stylesheet" href="<%=path46%>/google.css">
    <link rel="stylesheet" href="<%=path46%>/fonts.css">

    <!-- 필요한 플러그인 연결 -->
    <script src="https://code.jquery.com/jquery-latest.js"></script>
    <link rel="stylesheet" href="<%=path46%>/common.css">
    <link rel="stylesheet" href="<%=path46%>/header.css">
    <style>
            /*breadcrumb*/
        .content_header {
            clear: both;
    ...
    <link rel="stylesheet" href="<%=path46%>/footer.css">
    ...
    <div class="contents" id="contents">
        ...
        <section class="page">
            <div class="page_wrap">
                <h2 class="page_tit">오시는 길</h2>
                <div class="maparea">
                    <div id="map" style=" width:1000px;height:100vh; background:white; margin-top: -163px;">
                    <script>
